...
```{r}
wm_q <- poly2nb( # creates neighbours list from polygon list
  hunan,
  queen = TRUE, # TRUE: 1 shared bdry pts meets the contiguity condition,                    FALSE: need >1 shared pt;
)
summary(wm_q)
```
...
-   compute polygon centroids (points)
...
1.  [`knearneigh()`](https://r-spatial.github.io/spdep/reference/knearneigh.html) of **`spdep`**
...
-   [`nbdists()`](https://r-spatial.github.io/spdep/reference/nbdists.html) of **`spdep`**
