...
```{r}
pacman:::p_load(sf,tidyverse,spatstat,raster,terra,janitor,skimr,lubridate,tmap,gridExtra,patchwork) # more to be added
```
...
## Overview plots (from 2021-01-01 to 2024-06-31)
...
## Quarterly KDEs (excluding Riots)
...
## **Nearest Neighbour Analysis (TBD)**
