...
# write_rds(offenses_sf,'data/rds/offenses_sf.rds')
# write_rds(suspected_offenses_sf,'data/rds/suspected_offenses_sf.rds')
...
```{r}
# offenses_sf <- read_rds('data/rds/offenses_sf.rds')
# suspected_offences_sf <- read_rds('data/rds/suspected_offenses_sf.rds')
