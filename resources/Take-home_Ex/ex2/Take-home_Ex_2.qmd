...
tm_shape(combined_offenses_sf) + tm_polygons() + tm_text("ADM1_PCODE",size = 0.4)
qtm(combined_offenses_sf,"total_cases", title = "offenses")
qtm(combined_suspected_offenses_sf,"total_cases", title = "suspected")
```
